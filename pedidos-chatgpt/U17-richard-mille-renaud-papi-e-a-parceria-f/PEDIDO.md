# U17 — Richard Mille, Renaud & Papi e a parceria Ferrari: história com fontes

1. No Balcão, abra o pedido U17 e marque Rodei.
2. Cole o prompt no ChatGPT (GPT-5.6 Pro).
3. Salve a resposta como U17-entrega.zip em ~/repo/rmup01-digital-twin/_entrada/Balcao/.

---

PEDIDO U17 — Richard Mille, Renaud & Papi e a parceria Ferrari: história com fontes
...
TAREFA — Texto de estudo (não de hype) sobre: Richard Mille (a pessoa: formação, Mauboussin, fundação da marca em 2001), a marca (filosofia técnica, materiais, parcerias), Renaud & Papi / APRP / Audemars Piguet Le Locle (Giulio Papi, Dominique Renaud, papel no desenvolvimento de calibres para terceiros), e a parceria Richard Mille–Ferrari (início, modelos, o RM UP-01 como primeiro fruto). Entregar `historia-rm/texto.md` (3 000–4 500 palavras, com notas de rodapé para cada fato), `historia-rm/cronologia.csv`, fontes.csv. Marcar o que é fato documentado e o que é interpretação.

Devolva um único arquivo zip chamado U17-entrega.zip.

Onde estão os materiais de apoio (texto, pelo conector agenthub-tunnel): list_artifacts(run_id="run_20260921T030239_a5f9d6") e get_artifact(artifact_id=..., max_chars=60000). CHARTER.md (convenções de IDs) e ESQUEMAS.md (colunas dos CSV). Se o conector não responder, diga isso em vez de improvisar.
