# U05 — Patentes e registros da Richard Mille sobre caixa e movimento ultraplanos

1. No Balcão, abra o pedido U05 e marque Rodei.
2. Cole o prompt no ChatGPT (GPT-5.6 Pro).
3. Salve a resposta como U05-entrega.zip em ~/repo/rmup01-digital-twin/_entrada/Balcao/.

---

PEDIDO U05 — Patentes e registros da Richard Mille sobre caixa e movimento ultraplanos
...
TAREFA — Buscar patentes, modelos de utilidade e registros de desenho industrial da Richard Mille (e parceiros) que possam corresponder ao RM UP-01: caixa monobloco/caseband, fixação por parafusos spline, integração caixa-movimento para rigidez, cristais finos, seletor de função, coroa/comandos frontais. Entregar `patentes-rm/lista.csv` e `patentes-rm/analise.md` (o que cada uma ensina; grau de relação com o RM UP-01), com URLs de bases oficiais. Sem medidas de desenhos.

Devolva um único arquivo zip chamado U05-entrega.zip.

Onde estão os materiais de apoio (texto, pelo conector agenthub-tunnel): list_artifacts(run_id="run_20260921T030233_0a6299") e get_artifact(artifact_id=..., max_chars=60000). CHARTER.md (convenções de IDs) e ESQUEMAS.md (colunas dos CSV). Se o conector não responder, diga isso em vez de improvisar.
