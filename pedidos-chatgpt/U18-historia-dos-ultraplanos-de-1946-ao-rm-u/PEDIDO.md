# U18 — História dos ultraplanos: de 1946 ao RM UP-01

1. No Balcão, abra o pedido U18 e marque Rodei.
2. Cole o prompt no ChatGPT (GPT-5.6 Pro).
3. Salve a resposta como U18-entrega.zip em ~/repo/rmup01-digital-twin/_entrada/Balcao/.

---

PEDIDO U18 — História dos ultraplanos: de 1946 ao RM UP-01
...
TAREFA — Linha do tempo comentada dos relógios e calibres ultraplanos: Audemars Piguet calibre 9ML/2003 (1946/1953), Piaget 9P (1957) e 12P (1960), Jean Lassale 1.2 (1976), Concord Delirium (1979) e a "guerra dos ultraplanos", Jaeger-LeCoultre 145/849, Vacheron 1003, o renascimento (Piaget Altiplano 900P 2014, AP RD#2/RD#3, Bulgari Octo Finissimo 2014–2022, Piaget AUC 2020), até o RM UP-01 (2022). Para cada marco: data, dimensões, solução técnica que permitiu a espessura, custo em robustez/reserva, fonte. Entregar `ultraplanos/linha-do-tempo.md`, `ultraplanos/marcos.csv`, fontes.csv.

Devolva um único arquivo zip chamado U18-entrega.zip.

Onde estão os materiais de apoio (texto, pelo conector agenthub-tunnel): list_artifacts(run_id="run_20260921T030240_c94e0a") e get_artifact(artifact_id=..., max_chars=60000). CHARTER.md (convenções de IDs) e ESQUEMAS.md (colunas dos CSV). Se o conector não responder, diga isso em vez de improvisar.
