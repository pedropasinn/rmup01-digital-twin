# U10 — Anatomia comparada dos ultraplanos: Piaget, Bulgari, AP, Vacheron, Jaeger, Richard Mille

1. No Balcão, abra o pedido U10 e marque Rodei.
2. Cole o prompt no ChatGPT (GPT-6 Pro).
3. Salve a resposta como U10-entrega.zip em ~/repo/rmup01-digital-twin/_entrada/Balcao/.

---

PEDIDO U10 — Anatomia comparada dos ultraplanos: Piaget, Bulgari, AP, Vacheron, Jaeger, Richard Mille
...
TAREFA — Tabela dimensional e arquitetural, com fontes, dos calibres/relógios ultraplanos de referência: Piaget 9P e 900P/910P, Bulgari Octo Finissimo Ultra (BVL 180) e BVL 138, Audemars Piguet 2003 e RD#3, Vacheron 1003, Jaeger-LeCoultre 849/145, Jean Lassale 1.2, Concord Delirium, Richard Mille RM 67-01 e RM UP-01. Colunas: ano, dimensões do movimento e do relógio, frequência, reserva, rubis, tipo de escape, barrilete (rotação rápida? peripheral?), balanço, como resolveram a espessura (arquitetura espalhada, caixa como platina, cristais finos). Entregar `comparado/tabela.csv`, `comparado/analise.md` (o que o RM UP-01 herda e o que é inédito), fontes.csv.

Devolva um único arquivo zip chamado U10-entrega.zip.

Onde estão os materiais de apoio (texto, pelo conector agenthub-tunnel): list_artifacts(run_id="run_20260921T030235_bffe2f") e get_artifact(artifact_id=..., max_chars=60000). CHARTER.md (convenções de IDs) e ESQUEMAS.md (colunas dos CSV). Se o conector não responder, diga isso em vez de improvisar.
