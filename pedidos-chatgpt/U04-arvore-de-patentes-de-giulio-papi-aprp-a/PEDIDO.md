# U04 — Árvore de patentes de Giulio Papi / APRP / AP Le Locle sobre escapes e ultraplanos

1. No Balcão, abra o pedido U04 e marque Rodei.
2. Cole o prompt no ChatGPT (GPT-6 Pro).
3. Salve a resposta como U04-entrega.zip em ~/repo/rmup01-digital-twin/_entrada/Balcao/.

---

PEDIDO U04 — Árvore de patentes de Giulio Papi / APRP / AP Le Locle sobre escapes e ultraplanos
...
TAREFA — Levantar, em Espacenet, Google Patents, WIPO e Swissreg, a família da EP3754433A1 e as patentes relacionadas com inventor Giulio Papi ou titular Audemars Piguet/APRP/Renaud & Papi que tratem de escapes, ultraplanos, barriletes, seletores de função e cristais. Entregar `patentes/arvore.md` (famílias, prioridades, titulares, status legal, CPC, relação com o RM UP-01: certa / provável / apenas temática), `patentes/patentes.csv` (número, título, prioridade, publicação, titular, inventores, status, CPC, URL, o que ensina em uma linha) e uma lista das que merecem leitura completa. Sem medidas de desenhos.

Devolva um único arquivo zip chamado U04-entrega.zip.

Onde estão os materiais de apoio (texto, pelo conector agenthub-tunnel): list_artifacts(run_id="run_20260921T030232_665c3f") e get_artifact(artifact_id=..., max_chars=60000). CHARTER.md (convenções de IDs) e ESQUEMAS.md (colunas dos CSV). Se o conector não responder, diga isso em vez de improvisar.
