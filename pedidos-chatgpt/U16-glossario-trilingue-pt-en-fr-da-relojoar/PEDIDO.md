# U16 — Glossário trilíngue pt/en/fr da relojoaria ultraplana e do RM UP-01

1. No Balcão, abra o pedido U16 e marque Rodei.
2. Cole o prompt no ChatGPT (GPT-5.6 Pro).
3. Salve a resposta como U16-entrega.zip em ~/repo/rmup01-digital-twin/_entrada/Balcao/.

---

PEDIDO U16 — Glossário trilíngue pt/en/fr da relojoaria ultraplana e do RM UP-01
...
TAREFA — Glossário de 120–160 termos (pt, en, fr) cobrindo: escape de alavanca e seus componentes, balanço/espiral/Kif, barrilete e corda, trem, motion works, platina/pontes, rubis e pivôs, cristais e caixa, seletor de função, termos de espessura e ultraplanos, classes de evidência do projeto, metrologia de imagem (homografia, landmark, overlay). Cada termo: definição de 1–3 frases para leigo, sinônimos, en, fr, e "no RM UP-01:" quando se aplicar. Entregar `glossario/glossario.md` e `glossario/glossario.json` (lista de objetos com os campos).

Devolva um único arquivo zip chamado U16-entrega.zip.

Onde estão os materiais de apoio (texto, pelo conector agenthub-tunnel): list_artifacts(run_id="run_20260921T030238_46bad2") e get_artifact(artifact_id=..., max_chars=60000). CHARTER.md (convenções de IDs) e ESQUEMAS.md (colunas dos CSV). Se o conector não responder, diga isso em vez de improvisar.
