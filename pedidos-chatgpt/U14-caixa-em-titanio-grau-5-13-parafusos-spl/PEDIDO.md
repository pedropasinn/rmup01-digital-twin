# U14 — Caixa em titânio grau 5, 13 parafusos spline e cristais de 0,20–0,45 mm

1. No Balcão, abra o pedido U14 e marque Rodei.
2. Cole o prompt no ChatGPT (GPT-5.6 Pro).
3. Salve a resposta como U14-entrega.zip em ~/repo/rmup01-digital-twin/_entrada/Balcao/.

---

PEDIDO U14 — Caixa em titânio grau 5, 13 parafusos spline e cristais de 0,20–0,45 mm
...
TAREFA — Dossiê sobre a caixa e os cristais do RM UP-01: o que a marca publica (materiais, parafusos, resistência à água, integração caixa-movimento), propriedades do titânio grau 5 (norma, densidade, módulo, escoamento, com fonte), o que cristais de safira de 0,20/0,30/0,45 mm implicam (deflexão sob pressão de dedo com a fórmula de placa mostrada, risco de fratura, por que 0,20 no centro e 0,30 na borda), parafusos spline (o que são, por que RM os usa), e como outros ultraplanos fixam cristal e movimento. Entregar `caixa/dossie.md`, `caixa/cristais.py` (cálculo de deflexão, stdlib), fontes.csv, claims.csv.

Devolva um único arquivo zip chamado U14-entrega.zip.

Onde estão os materiais de apoio (texto, pelo conector agenthub-tunnel): list_artifacts(run_id="run_20260921T030237_26ba0f") e get_artifact(artifact_id=..., max_chars=60000). CHARTER.md (convenções de IDs) e ESQUEMAS.md (colunas dos CSV). Se o conector não responder, diga isso em vez de improvisar.
